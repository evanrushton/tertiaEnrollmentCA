...
DT16 <- listToDataTable(en0916.list, c("2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017"), id="YEAR")
...
na16 <- DT16[which(is.na(ETHNIC)),]
unique(na16[,.(CDS_CODE)]) # 38 schools without enrollment for a year or more
...
write.csv2(DT16, "./Transformed_Data/CA/0916.csv", na = "NA")
